              ...
              <div className="flex items-center gap-2 mb-1.5">
                ...
                {previewUrl && (
                  <div className="ml-auto flex gap-3">
                    <button type="button" onClick={() => window.open(previewUrl)} className="text-jungle-teal-600 hover:text-azure-mist-700 transition-colors flex items-center justify-center p-1 rounded hover:bg-jungle-teal-100" title="Full Screen">
                      <Maximize2 className="w-4 h-4" />
                    </button>
                    <button type="button" onClick={() => {
                        const printWin = window.open(previewUrl);
                        if(printWin) {
                           printWin.onload = () => printWin.print();
                        }
                    }} className="text-jungle-teal-600 hover:text-azure-mist-700 transition-colors flex items-center justify-center p-1 rounded hover:bg-jungle-teal-100" title="Print">
