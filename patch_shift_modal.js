...
c = c.replace(/const otherTaka = \(\(\(targetSummary\?\.total_other_sales_paisa \|\| 0\)\) \/ 100\)\.toFixed\(2\);/g,
...
const oldBox = `<div className="p-3 bg-white border border-jungle-teal-200 rounded-2xl shadow-xs">
...
const newBox = `<div className="p-3 bg-white border border-jungle-teal-200 rounded-2xl shadow-xs">
                  <span className="text-[10.5px] text-jungle-teal-600 font-sans block">Digital Sales</span>
